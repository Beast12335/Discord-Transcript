    ...
    */ 
    ...
    out.on("finish", function (err, result) {
      try { // try to send the file
        ...
        message.channel.send({channel ID:`914051184820633620`,content:`  `,files:[attachment]}).then(del => { //after sending it delete the file and edit the temp message to an approvement
