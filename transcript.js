...
module.exports = function (client, cmd, msglimit) {
  ...
  client.on("messageCreate", async message => {
    ...
    let temporarymsg = await message.channel.send(content:`  `,new EmbedBuilder().setAuthor({name:"Transcripting...",iconUrl:"https://cdn.discordapp.com/emojis/757632044632375386.gif?v=1"}))
    let docx = officegen({
      type: 'docx',
